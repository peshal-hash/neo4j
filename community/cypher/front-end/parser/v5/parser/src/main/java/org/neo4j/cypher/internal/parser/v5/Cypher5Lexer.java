// Generated from org/neo4j/cypher/internal/parser/v5/Cypher5Lexer.g4 by ANTLR 4.13.2
...
public class Cypher5Lexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"ARRAY", "AS", "ASC", "ASCENDING", "ASSERT", "ASSIGN", "AT", "AUTH", 
			"BAR", "BINDINGS", "BOOL", "BOOLEAN", "BOOSTED", "BOTH", "BREAK", "BRIEF", 
			"BTREE", "BUILT", "BY", "CALL", "CASCADE", "CASE", "CHANGE", "CIDR", 
			"COLLECT", "COLON", "COLONCOLON", "COMMA", "COMMAND", "COMMANDS", "COMMIT", 
			...
			"OPTIONS", "OPTION", "OR", "ORDER", "OUTPUT", "PASSWORD", "PASSWORDS", 
			"PATH", "PATHS", "PERIODIC", "PLAINTEXT", "PLUS", "PLUSEQUAL", "POINT", 
			...
			"REPEATABLE", "REPLACE", "REPORT", "REQUIRE", "REQUIRED", "RESTRICT", 
			...
			"USERS", "USING", "VALUE", "VARCHAR", "VECTOR", "VERBOSE", "VERTEX", 
			"WAIT", "WHEN", "WHERE", "WITH", "WITHOUT", "WRITE", "XOR", "YIELD", 
			"ZONE", "ZONED", "IDENTIFIER", "ARROW_LINE", "ARROW_LEFT_HEAD", "ARROW_RIGHT_HEAD", 
			"LETTER", "PART_LETTER", "A", "B", "C", "D", "E", "F", "G", "H", "I", 
	...
	@Override
	public String getGrammarFileName() { return "Cypher5Lexer.g4"; }
